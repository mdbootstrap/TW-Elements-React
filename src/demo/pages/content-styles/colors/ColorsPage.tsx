...
const ColorsPage = () => {
  return (
    <div className="container my-12 mx-5">
      ...
      <h2
        className="mb-5 mt-12 text-3xl font-semibold leading-normal"
        id="shades"
        data-te-spy-item
      >
        Shades
      ...
      <div className="grid-rows-8 grid gap-4">
        ...
        <p className="bg-neutral-800 text-neutral-50 dark:bg-transparent">
          Lorem ipsum dolor sit amet
        </p>
        <p className="text-neutral-800 dark:bg-neutral-50 dark:text-neutral-900">
          Lorem ipsum dolor sit amet
        </p>
      </div>
    </div>
