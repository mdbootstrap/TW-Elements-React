...
const ShadowsPage = () => {
  return (
    <div className="container my-12 mx-5">
      ...
      <p className="mb-3">
        For light design and bright compositions use standard shadows. To apply
        a shadow to an element simply add one of the following classes to it.
      </p>
      ...
      <h2
        className=" mt-0 text-3xl font-semibold leading-normal"
        id="strong"
        data-te-spy-item
      >
        Strong shadows
      ...
      <p className="mb-3">
        Use the <code>.shadow-inner</code> utility to apply a subtle inset box
        shadow to an element. This can be useful for things like form controls
        or wells.
      </p>
      ...
      <p className="mb-3">
        Use <code>.transition-shadow</code> class to the element to apply a
        shadow hover effect.
      </p>
      ...
      <p className="mb-3">
        Theoretically, depending on the brightness of the image you should use
        standard or strong shadow. However, practical use shows that in most
        graphics
