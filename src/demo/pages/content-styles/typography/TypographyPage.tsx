...
const TypographyPage = () => {
  return (
    <div className="container my-12 mx-5">
      ...
      <p className="mb-3">
        Use the <code>text-neutral-500</code> utility classes to recreate the
      ...
      <p className="mb-3">
        Display heading is useful to make text stand out, and display heading
        larger with slightly more opinionated style. Heading classes can be
        applied to any element of a page.
      </p>
      ...
      <p className="mb-3">
        ...
        tags defining the element, instead of breaking the flow of the content.
      </p>
      ...
      <p className="mb-3">
        The <code>.blockquote</code> element indicates that the enclosed text is
      ...
      <p className="mb-3">
        Use the following code to create list items with ordered and unordered
        lists.
      </p>
      ...
      <p className="sm:text-start mb-5">
      ...
      <p className="mb-3">
        Use <code>text-wrap</code> property to specify that the browser can
        break a line of text inside the targeted element onto multiple lines in
        an otherwise unbreakable place.
      </p>
      ...
      <p className="mb-3">
        Use the following <code>leading-type</code> utility classes to set the
