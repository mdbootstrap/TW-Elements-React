...
const RadioPage = () => {
  return (
    <div className="container my-12 mx-5">
      ...
      <p className="mb-3">
        Radio buttons are most commonly used when you have a group of mutually
        exclusive choices and only one choice from that group is allowed.
      </p>
      ...
      <p className="mb-3">
        Use <code>disabled</code> attribute to both the <code>label</code> and
        the
      ...
      <p className="mb-3">
        Group radios in the same horizontal row by adding <code>flex</code>{" "}
        class for parent container.
      </p>
