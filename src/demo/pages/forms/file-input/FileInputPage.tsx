...
const FileInputPage = () => {
  return (
    <div className="container my-12 mx-5">
      ...
      <p className="mb-3">
        File input is a field which user can use to upload one or more files
        (photos, documents or any other file type) from the local storage.
      </p>

      <p className="mb-3">
        Most common use examples of file upload component is CSV upload CRM
        system, avatar picture upload, simple GIF upload.
      </p>
      ...
      <p className="mb-3">
        Use the <code>multiple</code> attribute to the input to add multiple
        files with one input.
      </p>
      ...
      <p className="mb-3">
        Use the <code>disabled</code> attribute to make file input unusable and
        un-clickable.
      </p>
