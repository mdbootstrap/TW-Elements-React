  ...
  return (
    <div className="container my-12 mx-5">
      ...
      <section>
        ...
        <p className="mb-3">
          Use <code>useState</code> to connect <code>TETabs</code> with{" "}
          <code>TETabsContent</code>.
        </p>
        <TabsBasicExample />
      </section>
      {/* <!-- Section: Basic example --> */}
      ...
      <section>
        ...
        <p className="mb-3">
          ...
          <code>TETabsItem</code>'s, use <code>fill</code> property. Notice that
          all horizontal space is occupied, but not every tabs item has the same
          width.
        </p>
        <TabsFill />
      </section>
      ...
      <section>
        ...
        {/* <!-- Description --> */}
        <p className="mb-3">
          For equal-width elements, use <code>justify</code> property. All
          horizontal space will be occupied by <code>TETabsItem</code>'s, but
          unlike the fill property above, every <code>TETabsItem</code> will be
          the same width.
        </p>
        <TabsJustify />
      </section>
      ...
      <section>
        ...
        {/* <!-- Description --> */}
        <p className="mb-3">
          Make vertical tabs by using <code>vertical</code> property. Add also
          classes <code>flex items-start</code> to the wrapper <code>div</code>.
        </p>
        <TabsVertical />
      </section>
      {/* <!-- Section: Vertical --> */}
