...
export default function CardWithHeaderAndFooterExample(): JSX.Element {
  return (
    <div className="flex justify-center space-x-2">
      <div
        className="block max-w-[22rem] rounded-lg bg-white text-center shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
        <div
