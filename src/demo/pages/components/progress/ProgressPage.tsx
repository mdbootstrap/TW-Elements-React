...
const ProgressPage = () => {
  return (
    <div className="container my-12 mx-5">
      ...
      <p className="mb-3">
        The progress component is mainly used to indicate the progress of a
        task, usually displayed as a progress bar.
      </p>

      <p className="mb-3">
        Use a progress bar element to display a percentage completion rate by
        using an inline style and the utility classes.
      </p>
      ...
      <p className="mb-3">
        ...
        <code>.bg-green-500</code>, <code>.bg-primary-500</code>,
        <code>.bg-yellow-500</code> or <code>.bg-red-500</code> class.
      </p>
