...
const ListGroupPage = () => {
  return (
    <div className="container my-12 mx-5">
      ...
      <p className="mb-3">
        The list groups are very useful and flexible component for displaying
        lists of elements in a beautiful manner.
      </p>

      <p className="mb-3">
        The most basic list group is an unordered list with list items and the
        proper classes. Build upon it with the options that follow.
      </p>
      ...
      <p className="mb-3">
        The class <code>.text-neutral-*</code> and <code>.cursor-default</code>{" "}
        is used to disable a specific item in the list group.
      </p>
      ...
      <p className="mb-3">
        Use <code>&lt;a&gt;</code> or <code>&lt;button&gt;</code> to create
