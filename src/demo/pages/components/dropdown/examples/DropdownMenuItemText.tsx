...
export default function DropdownMenuItemText(): JSX.Element {
  return (
    <TEDropdown className="flex justify-center">
      ...
      <TEDropdownMenu>
        <TEDropdownItem>
          <span className="block w-full min-w-[160px] pointer-events-none cursor-text whitespace-nowrap bg-transparent px-4 py-2 text-sm text-left font-normal text-neutral-700 focus:outline-none dark:text-neutral-200">
            Dropdown item text
          </span>
        </TEDropdownItem>
