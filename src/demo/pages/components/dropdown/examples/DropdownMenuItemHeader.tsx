    ...
    <TEDropdown className="flex justify-center">
      ...
      <TEDropdownMenu>
        <TEDropdownItem preventCloseOnClick>
          <h6 className="block w-full whitespace-nowrap cursor-text bg-transparent px-4 py-2 text-sm text-left font-semibold text-neutral-500 dark:text-neutral-200">
            Drodpown header
          </h6>
        </TEDropdownItem>
        <TEDropdownItem>
