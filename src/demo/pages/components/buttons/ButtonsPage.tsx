...
import ButtonLink from "./examples/ButtonLink";
  ...
  return (
    <div className="container my-12 mx-5">
      ...
      <section>
        ...
        {/* <!-- Description --> */}
        <p className="mb-3">
          Use the ripple effect and provide feedback to users in a simple and
          elegant way in the form of a wave animation. It also changes position
          depending on where each button is clicked.
        </p>
        <ButtonWithRipple />
      </section>
      {/* <!-- Section: With ripple --> */}
      ...
      <section>
        ...
        {/* <!-- Description --> */}
        <p className="mb-3">
          Buttons, as one of the key UI elements, must have their own hierarchy.
          This means that the user should be able to easily identify which
          button is the most important (primary button), which is less important
          (secondary button) and which presents completely additional
          information (tertiary button).
        </p>

        <p className="mb-3">
          Elements with strong, filled backgrounds and shadows attract attention
          the most, which is why <strong>button primary</strong> is built in
          this way.
        </p>

        <p className="mb-3">
          A delicate background without shadows is less engaging, so it is well
          suited for <strong>button secondary</strong>.
        </p>

        <p className="mb-3">
          The lack of background and shadow makes the element the least visible.
          These features characterize the
          <strong>button tertiary</strong>.
        </p>

        <p className="mb-3">
          <strong>Note:</strong> Button tertiary may require additional margins.
          Without extra margins, the button edge will be flush with adjacent
          elements (which is sometimes the desired result). If you need margin -
      ...
      <section>
        ...
        {/* <!-- Description --> */}
        <p className="mb-3">
          Link button is similar to the tertiary button (and often is used as a
          substitute). The difference is, that the link button has a background
          on hover and also has a default padding.
        </p>
        <ButtonLink />
      </section>
      {/* <!-- Section: Link --> */}
      ...
      <section>
        ...
        {/* <!-- Description --> */}
        <p className="mb-3">
          Use the following button styles to show the colors only for the border
          of the element.
        </p>
        <ButtonOutline />
      </section>
      ...
      <section>
        ...
        {/* <!-- Description --> */}
        <p className="mb-3">
          Use elements rounded corners with the <code>.rounded-full</code>{" "}
          property.
        </p>
        <div className="flex justify-center space-x-2">
      ...
      <section>
        ...
        {/* <!-- Description --> */}
        <p className="mb-3">
          Use floating action button that represents the primary action in an
          application. It's button that appears in front of all screen content,
      ...
      <section>
        ...
        {/* <!-- Description --> */}
        <p className="mb-3">
          See the live example of a fixed button in the bottom right corner of
          this page.
        </p>
      ...
      <section>
        ...
        {/* <!-- Description --> */}
        <p className="mb-3">
          Use the following styles to indicate a disabled button. This can be
          often used inside form elements to disable the submit button before
          all the form elements have been completed and validated.
        </p>
        <div className="flex justify-center space-x-2">
          <div className="space-x-2">
            <button
      ...
      <section>
        ...
        {/* <!-- Description --> */}
        <p className="mb-3">
          Use full width button to adjust it to the column width. Block buttons
          is more often used when creating layout for mobile devices.
        </p>
        <ButtonBlock />
      </section>
      {/* <!-- Section: Block buttons --> */}
