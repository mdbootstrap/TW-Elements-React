  ...
  return (
    <div className="container my-12 mx-5">
      ...
      <section>
        ...
        {/* <!-- Description --> */}
        <p className="mb-3">
          Use this responsive timeline component to show a series of data
          entries with a date, title, and description with a vertical line with
          dots on the left or right side of the wrapper element.
        </p>
      ...
      <section>
        ...
        {/* <!-- Description --> */}
        <p className="mb-3">
          Use this horizontally aligned timeline component to show a series of
      ...
      <section>
        ...
        {/* <!-- Description --> */}
        <p className="mb-3">
          Use this vertical timeline component with icons and badges to show a
          more advanced set of data.
        </p>
        <TimelineIcons />
      </section>
      {/* <!-- Icons --> */}
